...
class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) {
    ...
    return Movie(
      id: json['movie_id'] ?? json['id'], // Handle both backend and direct TMDB search results
      ...
      releaseYear: json['release_year'] ?? (json['release_date'] != null ? DateTime.tryParse(json['release_date'])?.year : null),
    );
  }
}